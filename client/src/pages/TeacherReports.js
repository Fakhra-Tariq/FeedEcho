...
export default function TeacherReports() {
  ...
  const { syncQuizzes } = useTeacherData();
          ...
          <table className="w-full">
              <thead>
                <tr className="bg-primary/5 text-left">
                  ...
                  <th className="px-5 py-3 text-xs font-semibold uppercase tracking-wide text-text-light">Students joined</th>
                ...
                <div className="flex items-start justify-between gap-4 p-6 border-b border-primary/10">
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-text">
                      {selectedSubmission.studentName || 'Anonymous Student'}
                    </h3>
