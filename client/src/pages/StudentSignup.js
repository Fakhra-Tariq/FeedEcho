...
const StudentSignup = () => {
  ...
  const { studentSignUp, studentSignInWithGoogle } = useAuth();
  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-4 py-10 bg-background">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-text mb-2">Student Sign Up</h1>
        <p className="text-text-light mb-6">Create your student account.</p>
        ...
        <div className="mt-4 text-center text-sm">
          ...
          <Link to="/student/auth" className="text-primary hover:text-primary-dark font-medium">
            Sign In
          </Link>
        </div>
      </div>
